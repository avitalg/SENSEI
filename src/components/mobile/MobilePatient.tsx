    ...
    <div className="mob-screen">
      ...
      <div className="mob-screen-body">
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button type="button" onClick={() => set({ recordOpen: true, recordPid: cp.id })} aria-label="הקלטה" style={{ flex: 1, height: 48, border: 'none', borderRadius: 12, background: 'var(--primary)', color: 'var(--on-accent)', fontSize: 14.5, fontWeight: 800, fontFamily: 'inherit', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
