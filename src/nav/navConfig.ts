...
export function navConfig(): NavDestination[] {
  return [
    ...
    { key: 'search', label: 'חיפוש', icon: 'M9.5 3a6.5 6.5 0 1 0 3.98 11.64L18.85 20 20 18.85l-5.36-5.37A6.5 6.5 0 0 0 9.5 3zm0 2a4.5 4.5 0 1 1 0 9 4.5 4.5 0 0 1 0-9z' },
