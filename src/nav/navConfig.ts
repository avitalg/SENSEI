...
export function navConfig(): NavDestination[] {
  return [
    ...
    { key: 'upload', label: 'העלאה והקלטה', icon: 'M9 16h6v-6h4l-7-7-7 7h4v6zm-4 2h14v2H5v-2z' },
...
export const ROUTE_TITLES: Record<string, string> = {
  ...
  upload: 'העלאה והקלטה', transcript: 'תמלול', summary: 'סיכום AI', meetingHistory: 'היסטוריית פגישות', upcomingMeetings: 'פגישות קרובות', session: 'פגישה',
