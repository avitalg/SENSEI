...
export function navConfig(): NavDestination[] {
  return [
    ...
    { key: 'sessions', label: 'הקלטות ותמלולים', icon: 'M12 14c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3zm5-3c0 2.76-2.24 5-5 5s-5-2.24-5-5H5c0 3.53 2.61 6.43 6 6.92V21h2v-3.08c3.39-.49 6-3.39 6-6.92h-2z' },
    { key: 'messages', label: 'הודעות', icon: 'M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z' },
    { key: 'tasks', label: 'משימות', icon: 'M22 5.18L10.59 16.6l-4.24-4.24 1.41-1.41 2.83 2.83 10-10L22 5.18zm-2.21 5.04c.13.57.21 1.17.21 1.78 0 4.42-3.58 8-8 8s-8-3.58-8-8 3.58-8 8-8c1.58 0 3.04.46 4.28 1.25l1.44-1.44A9.9 9.9 0 0 0 12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10c0-1.19-.22-2.33-.6-3.39l-1.61 1.61z' },
    { section: 'ניתוח ומדדים' },
    { key: 'outcomes', label: 'מדדי תוצאה', icon: 'M3.5 18.49l6-6.01 4 4L22 6.92l-1.41-1.41-7.09 7.97-4-4L2 16.99z' },
    { key: 'analytics', label: 'תובנות', icon: 'M5 9.2h3V19H5V9.2zM10.6 5h2.8v14h-2.8V5zm5.6 8H19v6h-2.8v-6z' },
    { key: 'reports', label: 'דוחות', icon: 'M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z' },
    { section: 'ידע ומשאבים' },
    { key: 'resources', label: 'ספריית משאבים', icon: 'M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z' },
    { key: 'documents', label: 'מסמכים', icon: 'M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z' },
...
export const ROUTE_TITLES: Record<string, string> = {
  dashboard: 'דף הבית', patients: 'מטופלים', patient: 'תיק מטופל', sessions: 'פגישות',
  upload: 'העלאת הקלטה', transcript: 'תמלול', summary: 'סיכום AI', timeline: 'ציר זמן',
  report: 'דוח הכנה', letter: 'מכתב קליני', dedup: 'איתור כפילויות', analytics: 'תובנות',
  tasks: 'משימות', notifications: 'מרכז ההתראות', help: 'עזרה', calendar: 'יומן',
  settings: 'הגדרות', search: 'תוצאות חיפוש', messages: 'הודעות', documents: 'מסמכים',
  reports: 'דוחות', outcomes: 'מדדי תוצאה',
