...
export default function NextMeetingReportPage() {
  ...
  return (
    <div className="rep-page" style={{ maxWidth: 880, margin: '0 auto' }}>
      <div className="rep-breadcrumb" style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: 'var(--text-muted)', marginBottom: 16 }}>
      ...
      <div className="rep-page-header" style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 20, gap: 16, flexWrap: 'wrap' }}>
        <div>
          ...
          <button type="button" onClick={goMeetingHistory} className="rep-history-link tap44">היסטוריית הפגישות המלאה ›</button>
        </div>
        <div className="rep-header-actions" style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
      ...
      <div className="rep-content" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        {/* patient card */}
        ...
        <div className="rep-quick-review" style={{ background: 'linear-gradient(120deg,var(--accent-grad-1),var(--accent-grad-2))', borderRadius: 10, padding: '22px 24px', color: 'var(--on-accent)' }}>
        ...
        {/* audio brief */}
        <div className="rep-card rep-audio-card" style={{ ...card, padding: '18px 22px', display: 'flex', alignItems: 'center', gap: 16 }}>
        ...
        {lastSummary && (
          <div className="rep-card" style={{ ...card, padding: 22 }}>
