// Settings screen — tab rail plus preference panes (profile · appearance · accessibility · data).
...
const STABS = [
  ...
  { key: 'data', label: 'נתונים', icon: 'M4 1h16c1.1 0 2 .9 2 2v6c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2zm0 12h16c1.1 0 2 .9 2 2v6c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2v-6c0-1.1.9-2 2-2z' },
];

const PANE_TABS = new Set(['profile', 'appearance', 'accessibility', 'data']);
