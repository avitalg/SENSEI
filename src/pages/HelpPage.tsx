...
const FAQ_SRC = [
  ...
  { q: 'מהם דגלי הסיכון וכיצד להתייחס אליהם?', a: 'דגלי הסיכון הם אינדיקציות שהבינה המלאכותית מזהה בשיחה (כגון ביטויי מצוקה). הם כלי עזר בלבד ואינם מהווים אבחנה רפואית. שיקול הדעת הקליני נותר תמיד בידי המטפל.' },
];
...
const TROUBLESHOOT = [
  ...
  { q: 'המסך נראה תקוע אחרי עדכון גרסה', a: 'רעננו את הדף (קונטרול+R או ⌘R). המערכת מזהה גרסה חדשה ומתאוששת אוטומטית; רענון ידני פותר כל מקרה קצה.' },
];
