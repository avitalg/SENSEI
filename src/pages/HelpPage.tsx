...
const FAQ_SRC = [
  { q: 'כיצד מעלים הקלטת פגישה?', a: 'בחרו מטופל, לחצו על "העלאת הקלטה", ובחרו בין העלאת קובץ להקלטה ישירה מהמיקרופון. בהעלאת קובץ גררו את האודיו או בחרו אותו מהמחשב; בהקלטה ישירה לחצו "התחלת הקלטה" ועצרו בסיום. המערכת תתמלל ותנתח את הפגישה אוטומטית. נתמכים MP3, WAV ו-M4A עד 25MB, וגם הקלטת דפדפן (WebM/OGG).' },
