...
**גישה טיפולית מרכזית:** EMDR (עיבוד מחדש בתנועות עיניים) בשילוב עיבוד קוגניטיבי
**רקע קליני:** נסיך צעיר שאיבד את אביו באסון בקניון, נשא אשמה כבדה על מותו, ברח מארץ מולדתו ופיתח דפוס נוקשה של הימנעות והדחקה רגשית ("האקונה מטאטה") שנמשך שנים.
...
🎙️ הקלטת המטפל (Note): "וואו, אינטגרציה מדהימה. המעבר המהיר מהימנעות כרונית לקבלת החלטה אקטיבית לחזור לארץ התקווה מראה על שבירה מלאה של דפוס הקהות הרגשית. התחברות מחדש לדמות האב דרך הכוכבים ולא דרך זיכרון המוות בקניון מסמנת אינטגרציה בריאה של הזיכרון. במפגש המעקב נתמקד במניעת נסיגה לנוכח הטריגרים הסביבתיים האמיתיים שיפגוש בממלכה הישנה."
