...
**Version:** 1.0.100 · **Stack:** Vite · React 18 · TypeScript · Hebrew RTL
...
- No visual-regression (Chromatic) yet. **Storybook** is set up (`npm run storybook` /
  `npm run build-storybook`) for the shared components + design tokens.
