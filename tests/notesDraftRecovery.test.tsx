...
const editTrigger = () => document.querySelector('[aria-label="עריכת הסיכום הכללי"]') as HTMLElement;
const notesArea = () => document.querySelector('textarea[aria-label="סיכום כללי"]') as HTMLTextAreaElement;
